...
$sql = "INSERT INTO publicaciones (usuario_id, titulo, descripcion, imagen) VALUES (?, ?, ?, ?)";
...
if ($stmt->execute()) {
    ...
    if (isset($_POST["etiquetas"])) {
        ...
        foreach ($_POST["etiquetas"] as $etiqueta_id) {
            ...
            $sql_etiqueta = "INSERT INTO publicaciones_etiquetas (publicacion_id, etiqueta_id) VALUES (?, ?)";
